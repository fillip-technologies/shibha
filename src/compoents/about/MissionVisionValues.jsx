...
const items = [
  {
    title: 'Our Mission',
    description:
      'To accelerate India\'s transition to clean, renewable solar energy by delivering world-class solar solutions that are affordable, reliable, and built to last — empowering every household and business to become energy independent.',
    icon: (
  ...
  },
  {
    title: 'Our Vision',
    description:
      'To be India\'s most trusted and innovative solar energy company — pioneering cutting-edge technology, setting new industry benchmarks, and creating a cleaner, greener planet for future generations.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: 'Our Values',
    description:
      'Integrity, excellence, and sustainability guide every decision. We believe in transparent pricing, honest consultation, premium quality components, and building lasting relationships with every customer.',
    icon: (
      <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="site-container relative z-10">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-400 sm:text-lg">
            The principles that guide us in our quest to deliver exceptional solar energy solutions across India.
          </p>
        </div>
